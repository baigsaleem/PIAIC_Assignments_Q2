...
def function3():
    ...
    x = a[np.array(a % (5*7) == 0)] #wrtie your code here
    return x
    """
    Expected Output:
...
def function8():
    ...
    x = x = np.arange(10).reshape(2,5) #write your code here
    x[:] = 6
    return x
...
def function14():
    ...
    ans = numpr.split(arr,4)#write your code here 
...
def fucntion20():
    ...
    return xyz(z) #Write your Code here
